    ...
    <div className="flex flex-col min-h-screen font-sans">
      ...
      <header className="w-full bg-white py-3 px-6 flex items-center justify-between sticky top-0 z-50 border-b border-gray-100">
        <div className="flex items-center">
          <Link href="/">
            <div className="flex items-center cursor-pointer">
              ...
              >
                <path
                  d="M16.8 8C16.8 10.2091 14.9091 12 12.6 12C10.2909 12 8.4 10.2091 8.4 8C8.4 5.79086 10.2909 4 12.6 4C14.9091 4 16.8 5.79086 16.8 8Z"
                  fill="black"
                />
                <path
                  d="M23.8 8C23.8 10.2091 21.9091 12 19.6 12C17.2909 12 15.4 10.2091 15.4 8C15.4 5.79086 17.2909 4 19.6 4C21.9091 4 23.8 5.79086 23.8 8Z"
                  fill="black"
                />
              </svg>
        ...
        <div className="flex items-center space-x-8">
          ...
          <Link
            href="/try-for-free"
            className="bg-[#0066FF] text-white px-4 py-2 rounded text-sm font-medium hover:bg-blue-700 transition-colors"
          >
            Try for free →
          </Link>
        </div>
      ...
      <section className="bg-white w-full pt-16 pb-20 flex flex-col items-center text-center px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-5 text-[#1A1A1A] leading-tight">
            Create high quality
            <br />
            presentations quickly with AI
          </h1>
          <p className="text-lg text-[#666666] mb-10 max-w-2xl mx-auto">
            Alai is a new presentation platform—because storytelling is about
            <br />
            ideas, not pixel tweaking
          </p>
          <Link href="/login">
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <p className="text-base text-[#666666]">
                  Easily arrange, resize, or reposition slide elements with
                  AI-powered responsive grid
                </p>
              </li>
              <li className="flex items-start">
                <div className="mr-3 mt-1 text-purple-600 text-lg">•</div>
                <p className="text-base text-[#666666]">
                  Content-aware layouts automatically adjust as you write
                </p>
              </li>
              <li className="flex items-start">
                <div className="mr-3 mt-1 text-purple-600 text-lg">•</div>
                <p className="text-base text-[#666666]">
                  Take full control manually, or let Alai&apos;s AI instantly
          ...
          <div className="w-full md:w-1/2 pl-0 md:pl-16 mb-12 md:mb-0">
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <p className="text-base text-[#666666]">
                  Instead of forcing a single AI-generated slide, Alai gives you
              ...
              <li className="flex items-start">
                <div className="mr-3 mt-1 text-yellow-600 text-lg">•</div>
                <p className="text-base text-[#666666]">
                  Explore different layouts, visual arrangements, content flow,
                  and constantly be refine exactly what you need
                </p>
              </li>
            </ul>
          </div>
            ...
            <div className="w-full md:w-1/2 md:pr-16 mb-12 md:mb-0">
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <p className="text-base text-[#666666]">
                    Seamlessly transform any element type into another
                  </p>
                </li>
                <li className="flex items-start">
                  <div className="mr-3 mt-1 text-blue-600 text-lg">•</div>
                  <p className="text-base text-[#666666]">
                    Work alongside AI as your co-creator, making iteration fast
                    and effortless
                  </p>
                </li>
              </ul>
          ...
          <div className="w-full md:w-1/2 pl-0 md:pl-16 mb-12 md:mb-0">
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <p className="text-base text-[#666666]">
                  Spend less time repeating content across slides
                </p>
              </li>
              <li className="flex items-start">
                <div className="mr-3 mt-1 text-green-600 text-lg">•</div>
                <p className="text-base text-[#666666]">
                  Terms and concepts you introduce early on are automatically
                  applied to later slides
                </p>
              </li>
            </ul>
          </div>
      ...
      <section className="w-full bg-black py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-16 text-white text-center leading-tight">
            A theming system that offers a wide aesthetic
            <br />
            range with just a few clicks
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className={`${theme.bg} rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300`}
              >
